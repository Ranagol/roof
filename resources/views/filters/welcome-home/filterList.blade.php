                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading text-center">
                            ...
                            <h2 class="sec__title">Your saved ad lists</h2>
...
{{--We use here the HomeSavedAdList component. This component needs the individual $filter object (:filter part), and the
number of nonprocessed ads belonging to the given saved filter (the :unprocessed-ads-count part. It also needs a number
for getting a random background picture for every saved list.
--}}
{{--                        <home-ad-list--}}
{{--                            :number="{{ json_encode($key) }}"--}}
{{--                            :filter="{{ json_encode($filter) }}"--}}
{{--                            :unprocessed-ads-count="{{ json_encode($filterCount[$filter['id']]) }}"--}}
{{--                        ></home-ad-list>--}}
                    @endforeach
                </div><!-- end row -->
            </div><!-- end container -->
    ...
    @else
        <h1>There are no filters to display for some reason</h1>
    @endif
@endif
